...
/**
 * Class AttendanceLegalEntitiesShiftsBalance
 * 
 * @property int $id
 ...
 * @package App\Models
 */
class AttendanceLegalEntitiesShiftsBalance extends Model
{
	protected $table = 'attendance_legal_entities_shifts_balances';
