...
/**
 * Class AttendanceWorktimelimitRestTimeDifferenceBonu
 * 
 * @property int $id
 ...
 * @package App\Models
 */
class AttendanceWorktimelimitRestTimeDifferenceBonu extends Model
{
	protected $table = 'attendance_worktimelimit_rest_time_difference_bonus';
