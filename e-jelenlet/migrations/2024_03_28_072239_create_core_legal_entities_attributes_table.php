...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('core_legal_entities_attributes', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->tinyInteger('visible_in_header')->default(0);
    ...
    {
        Schema::dropIfExists('core_legal_entities_attributes');
    }
};
